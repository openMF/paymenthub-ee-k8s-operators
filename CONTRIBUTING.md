# Contributing to paymenthub-ee-k8s-operators

Thank you for your interest in contributing to the paymenthub-ee-k8s-operators! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-k8s-operators/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-k8s-operators) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-k8s-operators.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-k8s-operators.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-k8s-operators.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-k8s-operators.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-k8s-operators.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-k8s-operators.git (push)
```
